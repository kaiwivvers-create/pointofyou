...
<head>
    ...
    <title><?php echo e($brandSettings->app_name); ?></title>
...
<body class="font-sans antialiased text-stone-800 overflow-x-hidden" style="background-color: <?php echo e($brandSettings->secondary_color); ?>;">

    <header class="w-full sticky top-0 z-50 backdrop-blur-md border-b" style="background-color: <?php echo e($brandSettings->secondary_color); ?>/90; border-color: <?php echo e($brandSettings->primary_color); ?>/60;">
        <div class="w-full px-4 sm:px-8 lg:px-14 py-4 flex items-center justify-between gap-4">
            <a href="https://bryan.rplkodingan.com" class="flex items-center gap-2 shrink-0">
                <?php if($brandSettings->logo): ?>
                    <img src="<?php echo e(asset('app-storage/' . $brandSettings->logo)); ?>" alt="<?php echo e($brandSettings->app_name); ?>" class="w-8 h-8 rounded-lg object-cover">
                <?php else: ?>
                    <span class="text-2xl" aria-hidden="true"><?php echo e($brandSettings->logo_fallback); ?></span>
                <?php endif; ?>
                <span class="font-display text-xl sm:text-2xl font-medium" style="color: <?php echo e($brandSettings->primary_font_color); ?>;"><?php echo e($brandSettings->app_name); ?></span>
            </a>
            ...
            <a href="<?php echo e(route('kiosk.welcome')); ?>" class="shrink-0 rounded-full px-5 py-2.5 text-sm font-semibold text-amber-50 hover:opacity-90 transition-colors" style="background-color: <?php echo e($brandSettings->primary_color); ?>;">
                Order Now
            </a>
        </div>
    </header>
    ...
    <section class="w-full relative min-h-[85vh] flex items-center">
        ...
        <div class="relative w-full px-4 sm:px-8 lg:px-14 py-20 lg:py-28">
            <div class="max-w-3xl">
                <p class="text-amber-200/90 text-sm sm:text-base font-medium mb-4"><?php echo e($brandSettings->landing_badge ?? 'Artisan bakery since 2026'); ?></p>
                <h1 class="font-display text-4xl sm:text-5xl lg:text-7xl font-semibold text-amber-50 leading-[1.15] mb-6">
                    <?php echo e($brandSettings->landing_kicker ?? 'Baked with love,<br class="hidden sm:block"> served with warmth'); ?>
        ...
        <div class="w-full grid lg:grid-cols-2 min-h-[28rem]">
            ...
            <div class="flex flex-col justify-center px-4 sm:px-8 lg:px-14 py-14 lg:py-20">
                ...
                <p class="text-amber-100/85 text-lg leading-relaxed mb-6">
                    <?php echo e($brandSettings->app_name); ?> started in a tiny home kitchen with one sourdough starter named Kai. Today we still mix every batch by hand, use local flour, and never rush the rise.
                </p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <?php $__currentLoopData = $reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <blockquote class="rounded-2xl bg-white p-6 sm:p-8 shadow-sm ring-1 ring-amber-100">
                        <p class="text-stone-600 leading-relaxed">"<?php echo e($review['quote']); ?>"</p>
                        <footer class="mt-6">
                            <cite class="not-italic font-semibold text-amber-950"><?php echo e($review['name']); ?></cite>
                            <p class="text-sm text-stone-500"><?php echo e($review['role']); ?></p>
                        </footer>
                    </blockquote>
    ...
    <footer class="w-full bg-amber-950 text-amber-200/80">
        <div class="w-full px-4 sm:px-8 lg:px-14 py-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
            <div>
                <p class="flex items-center gap-2 font-display text-xl font-semibold text-amber-50">
                    <?php if($brandSettings->logo): ?>
                        <img src="<?php echo e(asset('app-storage/' . $brandSettings->logo)); ?>" alt="<?php echo e($brandSettings->app_name); ?>" class="w-8 h-8 rounded-lg object-cover">
                    <?php else: ?>
                        <span aria-hidden="true"><?php echo e($brandSettings->logo_fallback); ?></span>
                    <?php endif; ?>
                    <?php echo e($brandSettings->app_name); ?>

                </p>
                <p class="mt-3 text-sm leading-relaxed"><?php echo e($brandSettings->address ?? '123 Baker Street'); ?><br><?php echo e($brandSettings->hours ?? 'Open daily 6am – 3pm'); ?></p>
            </div>
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    ...
                    ?>
                    <?php $__currentLoopData = $hoursLines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    <?php if($brandSettings->instagram): ?>
                        <li><a href="<?php echo e($brandSettings->instagram); ?>" target="_blank" class="hover:text-amber-50 transition-colors">Instagram</a></li>
                    <?php endif; ?>
                    <?php if($brandSettings->facebook): ?>
                        <li><a href="<?php echo e($brandSettings->facebook); ?>" target="_blank" class="hover:text-amber-50 transition-colors">Facebook</a></li>
                    <?php endif; ?>
                    <?php if($brandSettings->phone): ?>
                        <li><a href="tel:<?php echo e(preg_replace('/[^0-9]/', '', $brandSettings->phone)); ?>" class="hover:text-amber-50 transition-colors"><?php echo e($brandSettings->phone); ?></a></li>
                    <?php endif; ?>
                </ul>
            </div>
        </div>
        <div class="w-full border-t border-amber-800 px-4 sm:px-8 lg:px-14 py-6 text-center text-sm text-amber-300/60">
            &copy; <?php echo e(date('Y')); ?> <?php echo e($brandSettings->app_name); ?>. Made with butter and joy.
        </div>
...
<?php /**PATH C:\Users\cindy\OneDrive\Documents\tick B\pplg\writing hting\pointofyou\pointofyou\resources\views/welcome.blade.php ENDPATH**/ ?>