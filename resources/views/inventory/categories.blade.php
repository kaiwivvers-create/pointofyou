...
<div class="max-w-4xl mx-auto">
    <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <p class="mt-1 text-sm text-slate-500">These are the same categories used by `menu_items.category`.</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl border border-slate-200 overflow-hidden shadow-sm mb-8">
        ...
        @if($categories->isEmpty())
            <div class="p-8 text-center text-slate-500">No categories defined.</div>
        @endif
    </div>
