...
<div id="chatbot-widget" class="fixed z-50" style="bottom: 1.5rem; right: 1.5rem;">
    <!-- Chat Button -->
    <button id="chatbot-toggle" class="w-14 h-14 rounded-full shadow-lg flex items-center justify-center transition-all duration-300 hover:scale-110 cursor-move" style="background-color: {{ $brandSettings->primary_color }};">
    ...
    <div id="chatbot-window" class="hidden absolute bg-white rounded-2xl shadow-2xl flex flex-col overflow-hidden" style="width: 20rem; height: 24rem; z-index: 100;">
        <!-- Header -->
        <div class="p-4 text-white cursor-move" style="background-color: {{ $brandSettings->primary_color }};">
        ...
        <div id="chatbot-messages" class="flex-1 overflow-y-auto p-4 space-y-3">
            <div class="flex gap-2">
                <div class="w-8 h-8 rounded-full flex items-center justify-center text-white text-xs font-semibold flex-shrink-0" style="background-color: {{ $brandSettings->primary_color }};">
                    AI
                </div>
        ...
        <div class="p-3 border-t border-slate-200 flex gap-2">
            ...
            <button onclick="sendMessage()" class="w-10 h-10 rounded-full flex items-center justify-center text-white transition-colors" style="background-color: {{ $brandSettings->primary_color }};">
...
function addUserMessage(message) {
    ...
    div.innerHTML = `
        <div class="rounded-2xl rounded-tr-none p-3 max-w-[80%]" style="background-color: {{ $brandSettings->primary_color }};">
