@php
    ...
    // Fallback for permissions if they don't exist yet for this role
...
<div class="h-full flex flex-col justify-between overflow-y-auto hidden-scrollbar pb-6 pt-2">
    <div class="space-y-6">
        ...
        @if ($can('dashboard') || $can('brand_settings'))
            <div>
                ...
                <div class="flex flex-col gap-0.5">
                    @if ($can('dashboard'))
                        @include('partials.staff-nav-link', [
                            'href' => $user->isSuperAdmin() ? route('super-admin.dashboard') : ($user->isOwner() ? route('owner.dashboard') : ($user->isManager() ? route('manager.dashboard') : route('admin.dashboard'))),
                            'label' => 'Dashboard',
                            ...
                            'active' => request()->routeIs('super-admin.dashboard') || request()->routeIs('owner.dashboard') || request()->routeIs('manager.dashboard') || request()->routeIs('admin.dashboard'),
                        ])
                    @endif
            ...
            <div>
                ...
                <div class="flex flex-col gap-0.5">
                    @include('partials.staff-nav-link', [
                        ...
                        'icon' => '<svg class="size-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',
