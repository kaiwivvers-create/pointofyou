@if(isset($promos) && $promos->isNotEmpty())
    <section class="mb-10">
        ...
        @if($promos->count() === 1)
            ...
            @endphp
            <div class="relative overflow-hidden rounded-[2rem] border border-amber-200/70 bg-white shadow-[0_20px_50px_rgba(120,53,15,0.08)]">
                    ...
                    <div class="relative min-h-[300px] md:min-h-[360px] overflow-hidden select-none text-white">
                        ...
                        <div class="relative z-20 flex h-full flex-col justify-between p-6 md:p-10">
                            ...
                            <div class="max-w-xl">
                                ...
                                <p class="mt-4 max-w-lg text-base md:text-lg leading-relaxed text-white/95">{{ $promoDescription }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    @for ($repeat = 0; $repeat < 5; $repeat++)
                        @foreach($promos as $promo)
                            @php
                                ...
                                $promoDescription = $promo->description ?: 'Limited-time offer available now.';
                            @endphp
                            <article class="promo-slide min-w-full flex-shrink-0">
                                <div class="grid gap-0 md:grid-cols-[1.15fr_0.85fr]">
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        promoBanner.addEventListener('pointerdown', (event) => {
            ...
            promoBanner.setPointerCapture(event.pointerId);
        });
