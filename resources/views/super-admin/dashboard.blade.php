...
@section('content')
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        ...
        <div class="staff-card p-6">
            ...
            <a href="{{ route('admin.tables.index') }}" class="staff-btn-primary w-full mb-4 block text-center">View Table QR Codes</a>
        ...
        <div class="staff-card p-6">
            ...
            <a href="{{ route('super-admin.database.index') }}" class="staff-btn-secondary w-full mb-4 block text-center">
                Download Backup
            </a>
